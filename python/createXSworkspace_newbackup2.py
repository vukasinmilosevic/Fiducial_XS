...
#########
            SigmaXHBin[str(genbin)] = RooRealVar('SigmaXHBin'+str(genbin), 'SigmaXHBin'+str(genbin), fidxs['4l'], 0.0, 10.0)
...
#def createXSworkspace(obsName, channel, nBins, obsBin, observableBins, usecfactor, addfakeH, modelName, physicalModel, year, obs_ifJES, obs_ifJES2, zzFloatType = ''):
createXSworkspace('pT4l', "4e", 9, 0, ['0', '15', '30', '45', '80', '120', '200', '350', '600', '13000'],False, True,"SM_125", "v3", "2018", False, '',)
