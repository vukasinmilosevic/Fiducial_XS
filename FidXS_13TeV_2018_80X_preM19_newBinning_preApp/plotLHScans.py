...
for obsName in observables:
    ...
    elif obsName=='mass4lj': obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4','SigmaBin5']
    elif obsName=="njets_pt30_eta2p5" or obsName=="njets_pt30_eta4p7": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4']
    elif obsName=="pt_leadingjet_pt30_eta2p5" or obsName=="pt_leadingjet_pt30_eta4p7": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4']
    elif obsName=="pTj2": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3']
    elif obsName=="mj1j2" or obsName=="pT4lj": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2']
    else: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4']# njets, Phi, cosTheta

    for obsbin in obsbins:

#        if (obsName=="cosTheta1" and obsbin=="0"): continue

        f = TFile("higgsCombine"+obsName+"_"+obsbin+".MultiDimFit.mH125.38.root","READ")
        if (f==0): continue
...
#            x = 0.+i/200000.
            ...
            if abs(scanval-1.0)<.001 and x<bestfit:      # changed form 0.001 to 0.001
...
#	if ('zz' in obsbin):
	...
	if (not opt.LUMISCALE=="1.0"):
            ...
            if (opt.ERA=='2016') : latex2.DrawLatex(0.87, 0.94,"35.9 fb^{-1} (13 TeV)")
            elif (opt.ERA=='2017') : latex2.DrawLatex(0.87, 0.94,"41.7 fb^{-1} (13 TeV)")
            elif (opt.ERA=='2018') : latex2.DrawLatex(0.87, 0.94,"58.8 fb^{-1} (13 TeV)")
            else : latex2.DrawLatex(0.87, 0.94,"137 fb^{-1} (13 TeV)")


#        if (not opt.LUMISCALE=="1.0"):
#            lumi = round(58.8*float(opt.LUMISCALE),1)
##            lumi = round(137.0*float(opt.LUMISCALE),1)
#            latex2.DrawLatex(0.87, 0.94,str(lumi)+" fb^{-1} (13 TeV)")
#        else:
#            #latex2.DrawLatex(0.87, 0.95,"137.1 fb^{-1} (13 TeV)")
#            latex2.DrawLatex(0.87, 0.95,"137 fb^{-1} (13 TeV)")
	...
	elif obsName=="pT4l" or obsName=="rapidity4l" or obsName=="massZ2":
            if (obsbin=="SigmaBin0"):
...
#                resultsXS['SM_125_'+obsName+'_genbin6_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
	    ...
	    if (obsbin=="SigmaBin0"):
            ...
            if (obsbin=="SigmaBin3"):
                resultsXS['SM_125_'+obsName+'_genbin3'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin3_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
	elif obsName=="pT4lj" or obsName=="mj1j2":
            if (obsbin=="SigmaBin0"):
                resultsXS['SM_125_'+obsName+'_genbin0'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin0_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin1"):
