...
#    os.chdir('../combine_files/') # TJ
    ...
    for physicalModel in PhysicalModels:
        ...
        if physicalModel == 'v4':
            ...
            cmd = 'combine -n _'+obsName+'_'+physicalModel+' -M MultiDimFit SM_125_all_13TeV_xs_'+obsName+'_bin_v3.root -m 125.38 --freezeParameters MH --floatOtherPOIs=1 --saveWorkspace --algo=singles --cminDefaultMinimizerStrategy 0 --robustHesse 1 --robustHesseSave 1 --setParameterRanges '
            for obsBin in range(nBins):
